...
#./build/bin/TumExample /home/rayzhang/media/Samsung_T5/tum/freiburg1_360 Examples/TumExample/cvo_rgbd_params.yaml Examples/TumExample/settings.txt 0 test_tum.txt
    ...
    for seq in  sfm_lab_room_1  #einstein_2 sfm_house_loop planar_2 mannequin_3 #360
	...
	./build/bin/TumExample /home/rayzhang/media/Samsung_T5/eth3d/${seq} Examples/TumExample/cvo_rgbd_params_eth3d.yaml Examples/TumExample/eth3d_settings.txt 115 test_eth3d_${seq}.txt
