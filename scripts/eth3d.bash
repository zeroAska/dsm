...
#./build/bin/TumExample /home/rayzhang/media/Samsung_T5/tum/freiburg1_360 Examples/TumExample/cvo_rgbd_params.yaml Examples/TumExample/settings.txt 0 test_tum.txt
    ...
    for seq in   sfm_bench sfm_lab_room_1 einstein_2 planar_2 #sfm_house_loop #360
    #for seq in  sfm_bench sfm_lab_room_1 einstein_2 planar_2 #sfm_house_loop #360
    do
        rm -rf eth3d_${seq}
        mkdir -p eth3d_${seq}
        ...
        ./build/bin/TumExample_no_qt /home/rayzhang/media/Samsung_T5/eth3d/${seq} Examples/TartanExample/cvo_outdoor_params_eth3d.yaml Examples/TumExample/eth3d_settings.txt 0 test_eth3d_${seq}.txt
