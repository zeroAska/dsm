...
do
    ...
    for seq in  desk2 #room xyz rpy
    do
        rm -rf tum_fr${idx}_${seq}
        mkdir -p tum_fr${idx}_${seq} 
        ./build/bin/TumExample /home/rayzhang/media/Samsung_T5/tum/freiburg${idx}_${seq} Examples/TumExample/cvo_rgbd_params.yaml Examples/TumExample/eth3d_settings_bki.txt 0 test_tum_fr${idx}_${seq}.txt
